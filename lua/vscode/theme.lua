...
theme.set_highlights = function(opts)
    ...
    hl(0, '@variable.member', { fg = c.vscBlueGreen, bg = 'NONE' })
    hl(0, '@property', { fg = c.vscBlueGreen, bg = 'NONE' })
    ...
    hl(0, 'luaLocal', { fg = c.vscBlue, bg = 'NONE' })
    ...
    hl(0, 'NeoTreeNormal', { fg = c.vscFront, bg = c.vscBack or c.vscLeftDark })
    hl(0, 'NeoTreeFloatNormal', { fg = c.vscFront, bg = c.vscBack or c.vscLeftDark })
    hl(0, 'NeoTreeFloatTitle', { fg = c.vscFront, bg = 'NONE' })
